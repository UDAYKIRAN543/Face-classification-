...
if __name__ == '__main__':
    ...
    #print(classify_image(None, "./test_images/serena3.jpeg"))
    ...
    #print(classify_image(None, "./test_images/messi4.jpeg"))
    #print(classify_image(None, "./test_images/MESSI1.jpg"))
    print(classify_image(None, "./test_images/sharapova_3.jpg"))
